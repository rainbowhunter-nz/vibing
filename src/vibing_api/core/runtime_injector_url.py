"""Resolve runtime control-plane URLs for sibling devcontainers.
...
When the control plane runs alongside uvicorn, substitute the container's own IP.
"""
...
def resolve_runtime_control_plane_url(url: str) -> str:
    parsed = urlparse(url)
